...
- Given the cost and time in industrial production, it would be infeasible for manufacturers to complete the comprehensive assessment of their products, especially for complex systems like an aircraft. So the product optimization should be through the whole life cycle. 
...
From the above, there are many roles and stages through the product life, so we need an unified model  to coordinate all the work and this is the reason for Digital Twin. 
