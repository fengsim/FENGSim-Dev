...
<p align="center">
  <img src="https://latex.codecogs.com/gif.latex?{\color{blue}\begin{equation}\Sigma = \dfrac{1}{\displaystyle\sum_{i:d_i\leq r}(r-d_i)}\sum_{i:d_i\leq r}(r-d_i)(P_i-F)(P_i-F)^T
\end{equation}}" />
 </p>
